							...
							>
								<div className="flex items-start space-x-4">
									<div className="w-12 h-12 bg-cosmic-purple rounded-full flex items-center justify-center flex-shrink-0">
										<publication.icon size={24} className="text-cosmic-gold" />
									</div>
									<div>
						...
						{projects.map((project, index) => (
							...
							>
								<div className="text-center mb-4">
									<div className="w-12 h-12 bg-cosmic-purple rounded-full flex items-center justify-center mx-auto mb-3">
										<project.icon size={24} className="text-cosmic-gold" />
									</div>
									<h4 className="text-xl font-bold text-cosmic-gold">
										{project.title}
									</h4>
								</div>
