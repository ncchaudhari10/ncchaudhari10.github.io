...
const researchProjects = [
	{
		...
		icon: Dna,
		description:
			"Leveraging diffusion models to generate functional protein structures up to 300 amino acids. Integrating RFdiffusion, AlphaFold, and ProteinMPNN for end-to-end protein design.",
	...
	},
	{
		...
		icon: Expand,
		description:
			"Developing advanced diffusion techniques for 4x image enhancement. Building upon CNN architectures with novel training methodologies.",
	...
	},
	{
		...
		icon: Network,
		description:
			"Exploring tokenization strategies for protein sequences using Graph Neural Networks. Advancing sequence representation learning for biological applications.",
